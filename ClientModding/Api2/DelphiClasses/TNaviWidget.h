...
class TNaviWidget : public TLBSWidget
{
public:
    static constexpr std::string_view NAME = "TNaviWidget";

    [[nodiscard]] TNaviChatViewer* getNaviChatViewer() noexcept { return naviChatViewer; }
