...
{
public:
	static constexpr std::string_view NAME = "TNTGameOptionWidget";
...
static_assert(sizeof(TNTGameOptionWidget) == 0x1E0, "TNTGameOptionWidget does not have a size of 0x1E0.");
