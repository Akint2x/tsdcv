...
{
public:
	explicit TEWCustomPanelWidget() {}
	static constexpr std::string_view NAME = "TEWCustomPanelWidget";
	...
	ImagePadding* getImagePadding() { return &imagePadding; }
	void setUnknown15(char value) { unknown15 = value; }

protected:
	char unknown15;							// 0x80
	char unknown16[8];						// 0x81
