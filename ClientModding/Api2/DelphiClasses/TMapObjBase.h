...
class TSmallIntList;
class TLBSMultiTextureCache;

class TMapObjBase : public TObject
{
public:

	void changeEntityColor(Bgra Bgra) noexcept
	{
		entityAlpha = Bgra.alpha;
		entityColor = Bgra;
	}
...
protected:
	...
	Bgra entityColor;							// 0x2C Note: changing alpha will not work, change the variable below
