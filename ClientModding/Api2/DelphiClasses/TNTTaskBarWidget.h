...
class TNTWebBrowserFormWidget;
class TNTNewCharacterStandardInfoWidget;
class TEWLabel;

class TNTTaskBarWidget : public TEWCustomFormWidget
{
public:
	static constexpr std::string_view NAME = "TNTTaskBarWidget";

	[[nodiscard]] TEWGraphicButtonWidget* getGameConfigBtn() { return gameConfigurationBtn; }
	[[nodiscard]] TEWGraphicButtonWidget* getHelpBtn() { return helpButton; }
