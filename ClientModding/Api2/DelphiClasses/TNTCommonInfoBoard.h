...
class TNTCommonInfoBoard : public TEWFormWidget
{
public:
	static constexpr std::string_view NAME = "TNTCommonInfoBoard";

	TEWStringListView* getDescription() noexcept { return description; }
